    ...
    brands: [
      {
        ...
        shortcuts: [
          ...
          { key: 'style',     value: 'soft lighting, warm tones, 24mm lens, shallow depth of field' },
          { key: 'motion',    value: 'slow drift, subtle parallax, no hard cuts' },
          { key: 'mission',   value: 'We create immersive brand worlds for forward-thinking companies.' },
        ],
      },
    ],
    activeBrandId: id,
    allowedDomains: ['dream.ai', 'lumalabs.ai'],
  })
})
